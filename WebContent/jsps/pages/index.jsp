...
<script>
	...
	function buildNewCardNovel(data){
		...
		clickableImg.style.width="100%"
		clickableImg.style.height = "100%"
		clickableImg.style.backgroundPosition = "center"
		clickableImg.style.backgroundSize="cover"
		clickableImg.style.backgroundRepeat="no-repeat"
