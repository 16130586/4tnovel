	...
	<div class="account-manage">
		...
		<div
			...
			<c:forEach var="novel" items="${account.ownNovels }">
				...
				<div class="row u-padding--05rem">
					<button class="col-md-6 btn btn-belike-a u-align-left"
						onclick="showOrHide('n1-v')">Watashi wa iku iku</button>
				...
				<div id="n1-v" style="display: none; background-color: #f0f0f0">
					<div class="row u-padding--05rem">
						<button class="col-md-10 btn btn-belike-a u-align-left"
							onclick="showOrHide('n1-v1-c')">vol1</button>
						<div class="col-md-2">
							<button class="btn btn-primary u-color-white">Sửa</button>
							<button class="btn btn-danger u-color-white">Xóa</button>
						</div>
					...
					<div id="n1-v1-c"
						...
						style="display: none; background-color: #e8e8e8">
						<div class="row">
							<button class="col-md-10 btn btn-belike-a u-align-left">chương
								1</button>
							<div class="col-md-2">
								<button class="btn btn-primary u-color-white">Sửa</button>
								<button class="btn btn-danger u-color-white">Xóa</button>
					...
					<div class="row u-padding--05rem">
						<button class="col-md-10 btn btn-belike-a u-align-left"
							onclick="showOrHide('n1-v2-c')">vol2</button>
						<div class="col-md-2">
							<button class="btn btn-primary u-color-white">Sửa</button>
							<button class="btn btn-danger u-color-white">Xóa</button>
						</div>
					...
					<div id="n1-v2-c"
						class="u-padding-bottom--05rem u-padding-right--05rem"
						style="display: none; background-color: #e4e4e4">
						<div class="row">
							<button class="col-md-10 btn btn-belike-a u-align-left">chương
								1</button>
							<div class="col-md-2">
			...
			<section>
				<div class="row u-padding--05rem">
					<button class="col-md-6 btn btn-belike-a u-align-left"
						onclick="showOrHide('n2-v')">Boku mo iku iku</button>
				...
				<div id="n2-v" style="display: none; background-color: #f0f0f0">
					<div class="row u-padding--05rem">
						<button class="col-md-10 btn btn-belike-a u-align-left"
							onclick="showOrHide('n2-v1-c')">vol1</button>
						<div class="col-md-2">
							<button class="btn btn-primary u-color-white">Sửa</button>
							<button class="btn btn-danger u-color-white">Xóa</button>
						</div>
					...
					<div class="row u-padding--05rem">
						<button class="col-md-10 btn btn-belike-a u-align-left"
							onclick="showOrHide('n2-v2-c')">vol2</button>
						<div class="col-md-2">
							<button class="btn btn-primary u-color-white">Sửa</button>
							<button class="btn btn-danger u-color-white">Xóa</button>
						</div>
