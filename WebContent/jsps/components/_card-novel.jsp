...
<div class="row card-novel">
	<div class="col-md-4 novel-img--box" style="margin: auto; width: 198px; height: 285px">
		<a href="detail?id=${novel.id }" style="width: 100%; height: 100%; background: url(${baseURL}/resources/imgs?id=${novel.coverId}); background-size: cover; background-position:center; background-repeat:no-repeat; display:block">
		</a>
	</div>
